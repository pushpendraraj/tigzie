...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>Create Deal</h2>
						
					</div>
					<div class="box-content">
                   		<?php echo $this->Form->create('Deal',array('method'=>'post','class'=>'form-horizontal none')); ?>
						
                       <?php echo $this->Form->input('Deal.restaurant_id',array('type'=>'hidden','value'=>$restaurant_id));
					   		echo $this->Form->input('Deal.deal_type',array('type'=>'hidden','value'=>'discount'));
					    ?>
