	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="<?php echo $this->webroot; ?>agent/dashboard"><?php echo $this->Html->image('logo.jpg',array('escape'=>false)); ?></a>
				<?php echo $this->element('agent_header');?>
					
                <div class="title">Welcome To Agent Panel</div><!--/.title -->
			</div>
		</div>
	</div>
	<!-- topbar ends -->
