...
<div class="row-fluid sortable">		
				<div class="box span12">
                   ...
                   <div class="pool_right"><?php $orderby=array('0'=>'All','1'=>'Restaurant','2'=>'Customer','3'=>'Agent');
					    echo $this->form->input('orderby',array('label'=>'Filter List','options'=>$orderby,'onchange'=>'change_order(this.value)'))?></div>
                          <div id="bookings"> Showing Page <?php echo $this->Paginator->counter(); ?><table class="table table-striped table-bordered">
						          <thead>                         
							       <tr>
